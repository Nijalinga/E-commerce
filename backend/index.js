...
app.use(cors(
    {
        origin:["https://e-backend-shoppify-niju.vercel.app"],
        methods:["GET","POST"],
        credentials:true, 
    }
));
...
// creating api for getting all poroducts
...
app.post('/signup',async (req,res)=>{
    ...
    if(check){
        return res.status(400).json({success:false,errors:"existing user found with same email adders"})
    }
    let cart={};
    for (let i = 0; i <300; i++) {
           cart[i]=0;
...
//cerating endpoint for popular in women
